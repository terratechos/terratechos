...
export const UpdatesSection = () => {
  ...
  const hasUpdates = UPDATES_DATA && UPDATES_DATA.length > 0;
          ...
          {hasUpdates ? (
            ...
            <div 
              className={`p-10 text-center rounded-xl border-2 border-dashed ${
                isDark ? 'border-[rgba(255,255,255,0.1)]' : 'border-[#d0e8da]'
              }`}
            >
              <p className="font-body text-sm italic" style={{ color: 'var(--tt-text-muted)' }}>
